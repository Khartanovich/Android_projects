...
class YearFromForSearchAdapter @Inject constructor(private val settingsUseCase : SettingsUseCase) : RecyclerView.Adapter<YearFromForSearchAdapter.YearForSearchViewHolder>() {
    ...
    override fun onBindViewHolder(holder: YearForSearchViewHolder, position: Int) {
        ...
        holder.binding.root.setOnClickListener {
            ...
            settingsUseCase.saveYearFrom(year)
        }
    }
